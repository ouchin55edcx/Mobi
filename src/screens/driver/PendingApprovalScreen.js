...
import {
  ...
  checkDriverStatus,
} from "../../shared/services/driverApprovalService";
...
const translations = {
  en: {
    ...
    message:
      "We are reviewing your driver registration. You will be notified once your account is approved.",
    status: "Status",
    pending: "Pending",
    approved: "Approved",
    rejected: "Rejected",
    ...
    approvedMessage:
      "Your driver account has been approved! You can now start using the app.",
  ...
  ar: {
    ...
    message:
      "نحن نراجع تسجيل السائق الخاص بك. سيتم إشعارك بمجرد الموافقة على حسابك.",
    status: "الحالة",
    ...
    approvedMessage:
      "تمت الموافقة على حساب السائق الخاص بك! يمكنك الآن البدء في استخدام التطبيق.",
    rejectedTitle: "تم رفض الحساب",
    rejectedMessage:
      "تم رفض حساب السائق الخاص بك. يرجى الاتصال بالدعم لمزيد من المعلومات.",
    ok: "حسناً",
    error: "خطأ",
...
const PendingApprovalScreen = ({
  ...
  const checkStatusAndNavigate = (status) => {
    if (status === "APPROVED" && onApproved) {
      Alert.alert(t.approvedTitle, t.approvedMessage, [
        {
          text: t.ok,
          onPress: () => {
            onApproved();
      ...
      >
          ...
          <View style={styles.statusCard}>
            <View style={styles.statusHeader}>
              ...
              <View style={styles.statusInfo}>
                <Text
                  style={[styles.statusLabel, language === "ar" && styles.rtl]}
                >
                  {t.status}
                </Text>
                <Text
        ...
        <View style={styles.messageContainer}>
          ...
          <View style={styles.waitingContainer}>
            <Text style={[styles.waitText, language === "ar" && styles.rtl]}>
              {language === "ar"
                ? "في انتظار موافقة المشرف..."
                : "Waiting for admin approval..."}
            </Text>
            <ActivityIndicator color="#3185FC" style={{ marginTop: 16 }} />
          </View>
        </View>
        ...
        >
          ...
          <Text
            style={[styles.logoutButtonText, language === "ar" && styles.rtl]}
          >
            {t.logout}
          </Text>
        </TouchableOpacity>
